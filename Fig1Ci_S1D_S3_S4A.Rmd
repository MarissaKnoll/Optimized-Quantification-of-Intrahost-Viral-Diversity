...
## What is the relationship between observed and expected allele frequency estimates? Fig 1C(influenza) & Fig S4A
```{r}
...
FigS4A = ggplot(TP, aes(x = as.numeric(Expected_freq), y = ALT_FREQ, color = Copy_number))+
...
FigS3 = ggplot(data = flu_cov, aes(x=ntpos, y=log10(totalcount), color = Sample)) +
